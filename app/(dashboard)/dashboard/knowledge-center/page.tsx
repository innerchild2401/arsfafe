    ...
    <div className="flex flex-col sm:flex-row h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6 space-y-4">
          {messages.length === 0 && (
            <div className="text-center text-gray-600 mt-12 sm:mt-16">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-indigo-100 mb-4">
                <svg className="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
              </div>
              <p className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Start a conversation</p>
              <p className="text-sm sm:text-base text-gray-600">Ask questions about your books</p>
            </div>
          )}
